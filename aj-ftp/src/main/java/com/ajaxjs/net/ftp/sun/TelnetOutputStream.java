...
public class TelnetOutputStream extends BufferedOutputStream {
    /**
     * Whether a CRLF pair should be treated as a single logical newline.
     */
    boolean stickyCRLF = false;

    /**
     * Whether the previously written character was a carriage return.
     */
    boolean seenCR = false;

    /**
     * Whether CR/LF conversion is disabled for binary transfer mode.
     */
    private final boolean binaryMode;

    /**
     * Creates a Telnet output stream.
     *
     * @param fd     underlying output stream
     * @param binary {@code true} to disable CR/LF conversion
     */
