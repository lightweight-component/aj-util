...
public enum Mode {
    ...
    /**
     * Constructs a mode with the specified mode indicator bits and character count bit widths.
     *
     * @param mode   the mode indicator bits
     * @param ccBits the character count bit widths for different version ranges
     */
