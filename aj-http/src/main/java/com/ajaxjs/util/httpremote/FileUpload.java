...
public class FileUpload {
    ...
    private static void writeFilePart(OutputStream out, String boundary, String fieldName, String fileName, InputStream in) throws IOException {
