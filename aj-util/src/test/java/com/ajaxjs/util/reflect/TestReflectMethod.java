...
//        assertNotNull(new ReflectMethod(A.class).getMethodByArgumentInterface("bar", new D()));// 找到了
...
//        assertEquals(method, reflectMethod.getMethodByArgumentInterface("inheritedInterface", new ChildImpl()));
//    }
//
