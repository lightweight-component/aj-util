...
public class StrUtil {
    ...
    public static String simpleTpl(String template, Map<String, Object> params) {
        ...
        while (m.find()) {
            ...
            String replacement = value == null ? CommonConstant.EMPTY_STRING : value.toString();
            m.appendReplacement(sb, Matcher.quoteReplacement(replacement));// 替换键值对应的值，若值为 null，则置为空字符串
        }
