...
public class URLEncoding {
    /**
     * Percent-escape marker written before encoded bytes.
     */
    private static final byte ESCAPE_CHAR = '%';

    /**
     * Radix used to render escaped bytes as hexadecimal.
     */
    private static final int HEXADECIMAL_RADIX = 16;

    /**
     * Character set used to convert Java text to bytes before encoding.
     */
    private static final Charset CHARSET = StandardCharsets.UTF_8;

    /**
     * Bytes that may remain unescaped in a canonical request path.
     */
    private static final BitSet PATH_UNESCAPED_CHARACTERS;

    /**
     * Bytes that may remain unescaped in a canonical query component.
     */
     ...
     * @param unescapedChars byte values that do not require escaping
     * @return encoded text using uppercase hexadecimal escapes
     * @throws NullPointerException if either argument is {@code null}
     */
    static String encode(String value, BitSet unescapedChars) {
