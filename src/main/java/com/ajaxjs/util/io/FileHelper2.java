...
public class FileHelper2 {
    ...
    public FileHelper2(Path path) {
        this.path = path;
    }

    public FileHelper2(File path) {
        this.path = path.toPath();
    }

    public FileHelper2(String path) {
    ...
    public FileHelper2 setTarget(File target) {
        this.target = target.toPath();
        return this;
    }

    public FileHelper2 setTarget(String target) {
